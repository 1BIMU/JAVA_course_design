...
public class ClientMessageHandlerFactory {
     ...
     */
    public ClientMessageHandlerFactory(ClientModel model, LoginController loginController, ChatController chatController, VoiceCallController voiceCallController) {
        // 注册各种消息处理器
